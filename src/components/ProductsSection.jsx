        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8">
            <ul class="filter__controls">
              ...
              <li data-filter=".women" class="">
                Women’s
              </li>
              <li data-filter=".men" class="">
                Men’s
              </li>
              <li data-filter=".kid" class="">
                Kid’s
              </li>
              <li data-filter=".accessories" class="">
                Accessories
              </li>
              <li data-filter=".cosmetic" class="">
                Cosmetics
              </li>
            </ul>
          </div>
        </div>
        <div class="row property__gallery" id="MixItUp2F922D">
